...
#This is used to visualize the real price and the predicted price
pred_df.select("features", "price", "prediction").orderBy("price", ascending=False).show()
